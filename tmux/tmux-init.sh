...
tmux new-window -t $workb:2 -n claude
tmux new-window -t $workb:3 -n claude2
tmux new-window -t $workb:4 -n code
tmux new-window -t $workb:5 -n code2
...
tmux new-window -t $workf:1 -n claude
tmux new-window -t $workf:2 -n code
tmux new-window -t $workf:3 -n code2
